 ...
 */
  ...
  export interface Map<K, V> extends Collection.Keyed<K, V> {
    ...
    diffFromCallbacks(otherSet: Map<K,V>, config: {
      add: (element: V, key: K) => any,
      remove: (element: V, key: K) => any,
      update: (prevNext: {prev: V, next: V}, key: K) => any
    });
  }
  ...
  export interface Set<T> extends Collection.Set<T> {
    ...
    diffFromCallbacks(otherSet: Set<T>, config: { 
      add: (element: T) => any,
