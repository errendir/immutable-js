...
ArrayMapNode.prototype.collectAllEntries = function collectAllEntries (collectingArray) {
...
HashCollisionNode.prototype.collectAllEntries = function collectAllEntries (collectingArray) {
  Array.prototype.push.apply(collectingArray, this.entries);
  return collectingArray;
};
...
ValueNode.prototype.collectAllEntries = function collectAllEntries (collectingArray) {
...
function processAllEntries(node1, node2, add, remove, update) {
  ...
  allEntries1.forEach(function (ref) {
    var key = ref[0];
    var value = ref[1];
  ...
  allEntries2.forEach(function (ref) {
    var key = ref[0];
    var value = ref[1];
...
function processDiffForEquivalentNodes(node1, node2, add, remove, update) {
  ...
  while (hashIndex1 < hashRanges1.length) {
    ...
    processAllEntries(subNode1$1, undefined, add, remove, update);
    hashIndex1 += 1;
  }
  while (hashIndex2 < hashRanges2.length) {
    var ref$3 = hashRanges2[hashIndex2];
    var subNode2$1 = ref$3.node;
    processAllEntries(undefined, subNode2$1, add, remove, update);
    hashIndex2 += 1;
  }
}
...
export { Collection, Iterable, Seq, Map, OrderedMap, List, Stack, Set, OrderedSet, Record, Range, Repeat, is, fromJS, hash, isImmutable, isCollection, isKeyed, isIndexed, isAssociative, isOrdered, isValueObject };
